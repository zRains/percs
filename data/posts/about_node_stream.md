...
![stream的理解#center;40;#](https://res.zrain.fun/images/2022/04/stream%E7%9A%84%E7%90%86%E8%A7%A3-250997c1315f9bf52cbe6adfc8d4a6ab.png)
...
表格中就是一些使用了流的原生 NodeJS 对象。其中有一些对象甚至是既可读又可写的，例如 TCP socket、zlib 以及 crypto 等。
...
![stream的缓冲池#pos:center;40;#](https://res.zrain.fun/images/2022/04/stream%E7%9A%84%E7%90%86%E8%A7%A3%20-1--9705a903c100c0aa68cc36f9916630dc.png)

> 缓冲池其实就是利用 Buffer 缓冲区实现，具体文章见[JS 的二进制家族](/posts/js_binary_family#buffer)
...
![stream的背压问题#;40;#](https://res.zrain.fun/images/2022/04/stream%E7%9A%84%E7%90%86%E8%A7%A3-7c3c87518e926c51c65d9e73c6969707.png)
...
Stream 是在 NodeJS 中处理流数据的抽象接口。Stream 并不是一个实际的接口，而是对所有流的一种统称。实际的接口有 ReadableStream（可读流）、 WritableStream（可写流）、ReadWriteStream（读写流） 这几个。
...
可以看出 ReadableStream 和 WritableStream 都是继承 EventEmitter 类的接口（ts 中接口是可以继承类的，因为他们只是在进行类型的合并）。上面这些接口对应的实现类分别是 Readable、Writable 和 Duplex。
...
![Pipe#;40;#](https://res.zrain.fun/images/2022/04/stream%E7%9A%84%E7%90%86%E8%A7%A3%20-1--615f4e5c48b2a9f2dd5c0399d17e184a.png)
