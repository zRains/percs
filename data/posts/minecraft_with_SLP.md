...
![Multiplayer_mode](https://res.zrain.fun/images/2022/09/Multiplayer_mode.png)
...
![handshake_packet_struct#;;true#](https://res.zrain.fun/images/2022/09/handshake_packet_struct.png)
...
![VarInt_encode_example#;;true#](https://res.zrain.fun/images/2022/09/VarInt_encode_example.png)
...
![wireshark_handshake_packet](https://res.zrain.fun/images/2022/09/wireshark_handshake_packet.png)
...
![status_request_packet#;60;true#](https://res.zrain.fun/images/2022/09/status_request_packet.png)
...
![wireshark_status_request_packet](https://res.zrain.fun/images/2022/09/wireshark_status_request_packet.png)
...
![wireshark_server_resopnse_packet](https://res.zrain.fun/images/2022/09/wireshark_server_resopnse_packet.png)
...
<small>
  \*
  在接收到响应数据包后，客户端可以发送下一个数据包，以帮助计算服务器的延迟，或者，如果客户端只对上述信息感兴趣，则可以在此处断开连接。
</small>

![ping_pong_packet#;;true#](https://res.zrain.fun/images/2022/09/ping_pong_packet.png)
