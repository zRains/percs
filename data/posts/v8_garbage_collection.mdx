...
![V8_areas#center;50;true#](https://res.zrain.fun/images/2022/06/V8_areas-49a7a79929f9ebe772220d18cd2374e1.png)
...
![v8_new_space_example_part_1#center;35;true#](https://res.zrain.fun/images/2022/06/v8_new_space_example_part_1-b1aca7863cebd3148690cbf67c8a9372.png)

当程序主线程任务第一次执行完毕后进入垃圾回收时，发现对象 A 已经没有其他引用，则表示可以对其进行回收，同时将依然活跃的 B，C 对象复制一份到 To 空间: 当程序主线程任务第一次执行完毕后进入垃圾回收时，发现对象 A 已经没有其他引用，则表示可以对其进行回收，同时将依然活跃的 B，C 对象复制一份到 To 空间:

![v8_new_space_example_part_2#center;35;true#](https://res.zrain.fun/images/2022/06/v8_new_space_example_part_2-8e9bc2e878b77a941b6b46dda31899e5.png)

清空 From 空间中的内容：

![v8_new_space_example_part_3#center;35;true#](https://res.zrain.fun/images/2022/06/v8_new_space_example_part_3-c82e5da670e5802181e009d0400a6396.png)

接着 From 空间和 To 空间进行一次角色互换，注意并不涉及**复制交换操作**：

![v8_new_space_example_part_4#center;35;true#](https://res.zrain.fun/images/2022/06/v8_new_space_example_part_4-2e932d72c647e0c9a5e1d1c43f31deb7.png)
...
![v8_mark_sweep_problem#center;35;true#](https://res.zrain.fun/images/2022/06/v8_mark_sweep_problem-306b592950957c91ced58013a664fc09.png)
...
![v8_mark_compact_example#center;35;true#](https://res.zrain.fun/images/2022/06/v8_mark_compact_example-26bc03a843f6fb8335ebf9e0f8c3bf25.png)
...
![v8_object_promotion#center;35;true#](https://res.zrain.fun/images/2022/06/v8_object_promotion-e5063ed675fb1b0a40bfb49121c20e01.png)
